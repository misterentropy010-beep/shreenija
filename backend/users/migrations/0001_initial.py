# Generated by Django 4.2.7 on 2025-11-03 11:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('team_leader', 'Team Leader'), ('manager', 'Manager'), ('driver', 'Driver'), ('user', 'General User'), ('corporate', 'Corporate Client')], default='user', max_length=20)),
